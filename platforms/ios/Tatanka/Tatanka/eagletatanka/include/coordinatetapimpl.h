#ifndef _COORDINATETAPIMPL_
#define _COORDINATETAPIMPL_

#include <string.h>
#include <math.h>
#include <cstdlib>
#include "types.h"
#include "coordinatetap.h"

#define null 0

class CoordinateTap;

class CoordinateTapImpl : public CoordinateTap {
public:
	unsigned char* name;
	float x;
	float y;
	...
	CoordinateTapImpl();
	CoordinateTapImpl(unsigned char* n);
