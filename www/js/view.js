...
View.prototype.paint = function() {	
	...
	var tx= 128*scale;
	this.ctx.fillText(this.siouxs, canvaswidth-tx, 80*scale);
	this.ctx.fillText(this.arrows, canvaswidth-tx, 136*scale);
	this.ctx.fillText(this.tatankahealth, canvaswidth-tx, 192*scale);
